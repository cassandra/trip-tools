...
class Command( BaseCommand ):
    ...
    def handle( self, *args, **options ):
        ...
        if not quiet:
            ...
            self.stdout.write( '' )
            self.stdout.write( 'To run E2E tests:' )
            self.stdout.write( '  1. Start the dev server: ./src/manage.py runserver' )
            self.stdout.write( '  2. Run tests: make test-e2e-extension-sim' )
            self.stdout.write( '' )
