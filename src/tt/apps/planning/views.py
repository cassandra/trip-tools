...
class PlanningHomeView( LoginRequiredMixin, TripViewMixin, View ):
    ...
    def get(self, request, trip_uuid: UUID, *args, **kwargs) -> HttpResponse:
        ...
        trip_page_context = TripPageContext(
            active_page = TripPage.PLANNING,
            request_member = request_member,
        )
        context = {
            'trip_page': trip_page_context,
        }
        return render(request, 'planning/pages/planning_home.html', context)
