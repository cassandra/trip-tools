...
urlpatterns = [
    ...
    path(
        'trip/<uuid:trip_uuid>/permission/<uuid:member_uuid>',
        views.MemberPermissionChangeView.as_view(),
        name = 'members_change_permission'
    ),
    path(
        'trip/<uuid:trip_uuid>/remove/<uuid:member_uuid>',
        views.MemberRemoveModalView.as_view(),
        name = 'members_remove'
    ),
    path(
        'trip/<uuid:trip_uuid>/accept/<str:email>/<str:token>',
        views.MemberAcceptInvitationView.as_view(),
        name = 'members_accept_invitation'
    ),
    path(
        'trip/<uuid:trip_uuid>/signup/<str:email>/<str:token>',
