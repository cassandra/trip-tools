...
class EnvironmentHomeView(View):
    ...
    def get_env_data_for_view(self):
        ...
        return {
            ...
            'DATABASE_HOST': settings.ENV.DATABASE_HOST,
            'DATABASE_PORT': settings.ENV.DATABASE_PORT,
            'DATABASE_NAME': settings.ENV.DATABASE_NAME,
            'DATABASES_NAME_PATH': settings.DATABASES['default']['NAME'],
            'STORAGE_ENDPOINT_URL': settings.ENV.STORAGE_ENDPOINT_URL,
            'STORAGE_REGION_NAME': settings.ENV.STORAGE_REGION_NAME,
            'STORAGE_BUCKET_NAME': settings.ENV.STORAGE_BUCKET_NAME,
            'STORAGE_LOCATION_PREFIX': settings.ENV.STORAGE_LOCATION_PREFIX,
            'STORAGE_CUSTOM_DOMAIN': settings.ENV.STORAGE_CUSTOM_DOMAIN,
